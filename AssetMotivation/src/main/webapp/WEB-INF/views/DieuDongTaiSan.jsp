...
<%@include file="Header.jsp" %>
    ...
    <div style="width: calc(100% - 250px); float: left; margin-left: 10px">
    	<h3 style="width:100%; text-align: center;">THÔNG BÁO TỔNG HỢP TÀI SẢN ĐIỀU ĐỘNG</h3>
       <form:form action="DieuDongTaiSan" method="POST" modelAttribute="moveObject">	
       	<div style="width: 100%; padding: 10px;">
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <label for="usr">TÊN TÀI SẢN</label>
                <form:input path="nameAsset"  type="text" class="form-control"/>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <label for="usr">MODEL</label>
                <form:input  path="modelAsset" type="text" class="form-control"/>
            </div>
        </div>
           <div class="col-sm-4">
            <div class="form-group">
                <label for="usr">SERIES</label>
                <form:input  path="seriesAsset" type="text" class="form-control"/>
            </div>
        </div>
...
<!--        		</div> -->
        ...
        <table class="table-data-new">
            <thead>
                <tr>
                    <th style="width:80px" class="cel-bor-top-black cel-bor-left-black">STT</th>
                    <th style="width:120px"  class="cel-bor-top-black">MÃ LỆNH</th>
                    <th style="width:120px"  class="cel-bor-top-black">TRẠNG THÁI</th>
                    <th   class="cel-bor-top-black">RFID</th>
                    ...
                    <th   class="cel-bor-top-black">BẮT ĐẦU</th>                   
                    <th   class="cel-bor-top-black">KẾT THÚC (KH)</th>
                    <th   class="cel-bor-top-black">XEM</th>
                </tr>
            </thead>
            <tbody>
            <% int stt=0; %>
            	 ...
            	 <c:if test="${elm.lstAsset != null}">
            		<c:forEach items="${elm.lstAsset}" var="item">
            			<c:choose>   
		                    ...
		                    <td  style="text-align: center">${elm.status}</td>
		                    <td>${item.rfid}</td>
		                    <td>${item.name}</td>
		                    <td>${item.model}</td>
		                    <td>${item.series}</td>
		                     <td>${item.accountCd}</td>
		                    <td  style="text-align: center">${elm.dateOut}</td>
