...
<%@include file="Header.jsp" %>
  <form:form action="XemLenhDieuDong" modelAttribute="TaoLenhDiChuyenNoiBoForm">
    <div style="width: 100%;">
        ...
        <div class="control-action">
            ...
            <button class="btn btn-action"  type="submit" name="export">XUẤT LỆNH</button>
        </div>
        	<span style="font-weight: 700; float:left;line-height: 35px;">Số lượng dòng: </span>
        	<input type="number" class="form-control" disabled="disabled" style="width:80px; float:left; margin-left: 10px; " name="numberRow" value="${numberRow}" min="${numberRow}" max="100">
