...
<%@include file="Header.jsp" %>
  <form:form action="KVTaiSanLenhDiChuyenNoiBo" modelAttribute="TaoLenhDiChuyenNoiBoForm">
    <div style="width: 100%;">
                ...
                <div class="col-lg-12" style="margin-bottom: 10px">
                 ...
                 <div class="col-lg-12" style="margin-bottom: 10px">
                    <label>KHAI BÁO TRẠNG THÁI TÀI SẢN:</label><br>
                      <form:input readonly="true"  path="commentCreate" type="text" class="form-control input-readonly"/>
                </div>
                 <div class="col-lg-12" style="margin-bottom: 10px">
                    <label>PHÒNG CƠ ĐIỆN NHẬN XÉT:</label><br>
                      <form:input readonly="true"   path="commentPCD" type="text" class="form-control input-readonly"/>
                </div>
                 <div class="col-lg-12" style="margin-bottom: 10px">
                    <label>KẾ TOÁN NHẬN XÉT:</label><br>
                      <form:input  readonly="true" path="commentAccount" type="text" class="form-control input-readonly"/>
                </div>
                 <div class="col-lg-12" style="margin-bottom: 10px">
                    <label>KHO VẬN NHẬN XÉT:</label><br>
                      <form:input  path="commentStock" type="text" class="form-control"/>
                </div>
            </div>
        ...
        <div class="control-action">
            ...
            <button class="btn btn-action"  type="submit" name="approve">DUYỆT </button>
            <button class="btn btn-action"  type="submit" name="disApprove">KHÔNG DUYỆT </button>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	 ...
                    	 <input type="text" readOnly="true" name="rfid_<%=stt%>" value="${elm.getRfid() }" class="form-control input-table-data">
                    </td>
                    <td>
                    	 <input type="text" readOnly="true" name="model_<%=stt%>" value="${elm.getModel() }" class="form-control input-table-data">
                    </td>
                    <td>
                    	 <input type="text" readOnly="true" name="series_<%=stt%>" value="${elm.getSeries() }" class="form-control input-table-data">
                    </td>
                    <td>
                    	 <input type="text" readOnly="true" name="name_<%=stt%>" value="${elm.getName() }" class="form-control input-table-data">
                    </td>
                    <td>
                    	 <input type="text" readOnly="true" name="assesseries_<%=stt%>" value="${elm.getAssesseries() }" class="form-control input-table-data">
                    </td>
